...
@author: LJH
"""
from RLbrain_old import Qnetwork
...
#参数
#batch_size = 128 #每个训练步需要的经验数量,可能就是训练神经网络的时候需要采取的数量值
...
r_output = open('C:/Users/Administrator/Desktop/code/rewardoutput10.csv','a+')
q_output = open('C:/Users/Administrator/Desktop/code/queueoutput10.csv','a+')
...
for i in range(1,num_episodes):
    ...
    while j < max_epLength:
        ...
        s1, r, d, wait_time,q_m = sumo.action(tls, ph, wait_time) #获得下一个状态、奖励、是否结束、以及等待时间
        ...
        if total_steps > pre_train_steps:
            ...
            if total_steps % (update_freq) == 0:
                ...
                indx_max = np.argmax(Q2,axis=1)
                doubleQ = Q2[range(batch_size),indx_max]
