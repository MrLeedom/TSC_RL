...
'''
   ...
   Created on Sat Mar 09 16:35:27 2019
   Description:这个no double 主要体现在main函数里面,所以需要结合着来看,主要是体现有木有把两个神经网络结合起来用
